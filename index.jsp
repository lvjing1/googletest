...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li><a href="productSelect">手机</a></li>
			<li><a href="ordersel">订单</a></li>
			<li><a href="SelManage">留言</a></li>
			<li><a href="newsselect">快讯</a></li>
		</ul>
	</div>
</div>
<div id="childNav">
...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">手机商城网站</a> &gt; 管理后台
</div>
	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dd><em><a href="productAdd">新增</a></em><a href="productSelect">手机管理</a></dd>
				<dt>订单管理</dt>
				<dd><a href="ordersel">订单管理</a></dd>
				<dt>留言管理</dt>
				<dd><a href="SelManage">留言管理</a></dd>
				<dt>快讯管理</dt>
				<dd><em><a href="news-add.jsp">新增</a></em><a href="newsselect">快讯管理</a></dd>
			</dl>
		</div>
	</div>
	<div class="main">
